...
class Drive extends React.Component {
    ...
    removeFile = () => {
        ...
        const removeEndpoint = 'http://35.200.183.53:3000/Remove?appName='+this.state.openWorkspace+'&senderPub='+b64Sender+'&name='+this.state.fileToBeDeleted+'&hash='+this.state.fileHashToBeDeleted;
    ...
    fetchSitemap = (appName, senderPub) => {
        const fetchingSiteMapURL = 'http://35.200.183.53:3000/explorer?AppName='+appName+'&senderPub='+senderPub;
    ...
    fetchSitemapOfWorkspace = (appName,appHash,benefactor) => {
        ...
        const url = 'http://35.200.183.53:3000/appdata/'+appHash+'?reciPub='+b64OfUser;
        console.log(url);
        axios.get(url)
        .then( response => {
    ...
    renderFile = (fileToBeRead, receipentAddress, appHistory,fileName,iteration) => {
        ...
        const readingUrl = 'http://35.200.183.53:3000/read/'+fileToBeRead+'?reciPub=' + b64OfReceipent;
    ...
    signUpWithb64 = () => {
        this.setState({loading:true});
        const b64OfSender =  window.btoa(this.state.sender.toLowerCase());
        const creatingDefaultAppIdUrl = 'http://35.200.183.53:3000/createAppID/'+b64OfSender+'?sender='+b64OfSender;
